...
const STAND_NAME = 'Fontur Stand principal'
...
const STAND_COLOR = '#3BBD24'
const STAND_BG = 'rgba(168,85,247,0.08)'

// Datos ficticios Stand 2 — reemplazar con datos reales
const STAND_DAYS: number[][] = [
   [235, 456, 689, 778, 789, 794, 945, 1045, 958, 845, 320],
  [384, 345, 578, 741, 768, 975, 748, 721, 987, 997, 289],
  [85, 275, 289, 774, 563, 645, 653, 647, 1143, 547, 286],
]
...
export default function EstadisticasStand() {
